...
class Lit4dVarNet_CROSCIM_Supervised(Lit4dVarNet_CROSCIM_inference):
    """
    ...
    def format_batch_for_solver(self, batch, include_masks=False, res=None, add_noise=False, noise_std=0.01):
        """
        ...
        return super().format_batch_for_solver(batch, include_masks=include_masks, res=res, add_noise=add_noise, noise_std=noise_std)
