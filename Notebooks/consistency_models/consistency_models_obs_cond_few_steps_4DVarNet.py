...
# Modified consistency for few-steps sampling as 4DVarNet

def model_few_steps_4DVarNet_forward_wrapper(
    model: nn.Module,
    obs_cost: nn.Module,
    ...
    **kwargs : Any
    ...
    return c_skip * x + c_out * model(x, grad, sigma1, sigma2, **kwargs)


class ConsistencyTrainingFewSteps_4DVarNet:
    ...
    def __call__(
        ...
        **kwargs : Any
        ...
        intermediate_from_current_x = model_few_steps_4DVarNet_forward_wrapper(
                student_model,
                obs_cost,
                prior_cost,
                lambda_reg,
        ...
        next_from_intermediate_x = model_few_steps_4DVarNet_forward_wrapper(
            student_model,
            obs_cost,
            prior_cost,
            lambda_reg,
        ...
        next_from_current_x = model_few_steps_4DVarNet_forward_wrapper(
                teacher_model,
                obs_cost,
                prior_cost,
                lambda_reg,
...
class ConsistencySamplingAndEditingFewSteps_4DVarNet:
    ...
    def __call__(
        ...
        **kwargs : Any
        ...
        for i in range(nsteps-1):
            ...
            x = model_few_steps_4DVarNet_forward_wrapper(
