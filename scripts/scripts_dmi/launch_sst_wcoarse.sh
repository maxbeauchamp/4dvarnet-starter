...
ckpt_path=/homes/m19beauc/4dvarnet-starter/ckpt/DMI/SST/sst_dmi_baltic_wcoarse.ckpt
...
for month in {1..12} ; do
  ...
  cp -rf config/xp/DMI/SST/sed_dmi_sst_test_wcoarse.yaml config/xp/DMI/SST/dmi_sst_test.yaml
