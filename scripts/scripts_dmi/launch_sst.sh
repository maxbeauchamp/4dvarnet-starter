...
ckpt_path=/homes/m19beauc/4dvarnet-starter/ckpt/DMI/SST/sst_dmi_baltic_dm3.ckpt
...
for month in {1..12} ; do
  ...
  cp -rf config/xp/DMI/SST/sed_dmi_sst_test.yaml config/xp/DMI/SST/dmi_sst_test.yaml
  ...
  HYDRA_FULL_ERROR=1 python main.py xp=DMI/SST/dmi_sst_test
