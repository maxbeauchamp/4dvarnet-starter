...
cp -rf ${scratch_dir}/version_$((N))/checkpoints/last.ckpt ckpt/DMI/SST/sst_dmi_baltic_rzf10.ckpt

# 2. inference on coarse training dataset
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 python main.py xp=DMI/SST/coarse/dmi_sst_all_baltic_rzf10_test_ontrain192021
N=`ls -Art ${scratch_dir}/ | tail -n 1 | cut -f2 -d'_'` 
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 python main.py xp=DMI/SST/coarse/dmi_sst_all_baltic_rzf10_test_onvalid21
N=`ls -Art ${scratch_dir}/ | tail -n 1 | cut -f2 -d'_'`
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 python main.py xp=DMI/SST/anom/dmi_sst_all_baltic_wcoarse_wgeo
N=`ls -Art ${scratch_dir}/ | tail -n 1 | cut -f2 -d'_'`
cp -rf ${scratch_dir}/version_$((N))/checkpoints/last.ckpt ckpt/DMI/SST/sst_dmi_baltic_wcoarse_wgeo.ckpt

# 5.inference
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 python main.py xp=DMI/SST/anom/dmi_sst_all_baltic_wcoarse_wgeo_test
or
