...
ckpt_path=/homes/m19beauc/4dvarnet-starter/ckpt/sst_dmi_baltic_wcoarse.ckpt
...
for month in {1..12} ; do
  ...
  cp -rf config/xp/sed_dmi_sst_test_wcoarse.yaml config/xp/dmi_sst_test.yaml
  ...
  HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=1 python main.py xp=dmi_sst_test
